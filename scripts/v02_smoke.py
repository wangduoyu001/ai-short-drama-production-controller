...
from short_drama_controller.v02_cli import init_project, load
...
from short_drama_controller.v02_cli import save
...
def main() -> None:
    ...
    required = [
        ...
        out_dir / "prompts.md",
        out_dir / "qa.md",
        out_dir / "exports" / "v02_video_prompts.md",
        out_dir / "exports" / "v02_sound_table.csv",
    ]
